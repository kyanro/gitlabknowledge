...
## gitlabのインストール
	...
	1. Packages / Dependencies
		...
		#のふたつのみを実行。sudoは使えてたから最後は無視したけど大丈夫だよね(´・ω・｀)
	...
	6. GitLab
		...
		##このメモではlocalhostを 192.168.1.201に変更したものとして話を進める
		...
		##production の password: に自分で設定したMySQLのrootパスワードを入力 
